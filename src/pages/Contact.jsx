export const Contact=()=>{
    return(
        <>  
            ...
            <br></br>
            <br></br>
            <h1> Hi my name is ASHUTOSH PATHAK </h1>
            <br></br>
            <br></br>
            <br></br>
            <br></br>
            <br></br>
            <h1>My Phone no is +91-8824984574 </h1>
            <h1>My email is ashutoshpathak1689@gmail.com</h1>
            <h1>My Github username is ASHUTOSHPATHAK44</h1>
