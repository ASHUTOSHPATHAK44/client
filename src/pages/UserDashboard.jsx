...
export const UserDashboard = () => {
    ...
    useEffect(() => {
      const fetchUserPolicies = async () => {
          try {
              const response = await fetch(`https://server-one-drab.vercel.app/api/policies/showPoliciesByUserId/${userId}`, {
                  headers: {
      ...
      const fetchAllPolicies = async () => {
        try {
            const response = await fetch(`https://server-one-drab.vercel.app/api/policies/showAllPolicies`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const fetchClaimsByUserId = async () => {
      try {
          const response = await fetch(`https://server-one-drab.vercel.app/api/claims/claimsByUserId/${userId}`, {
              headers: {
                  Authorization: `Bearer ${token}`,
              },
          });
  ...
  const handleBuyPolicy = async (policyId) => {
    try {
        const response = await fetch(`https://server-one-drab.vercel.app/api/purchase/buyPolicy`, {
            method: 'POST',
            headers: {
...
const handleClaim = async () => {
  try {
    // console.log('cajshjasfhkjhjfa' , policyId)
      const response = await fetch(`https://server-one-drab.vercel.app/api/claims/createClaim`, {
          method: 'POST',
          headers: {
              'Content-Type': 'application/json',
              Authorization: `Bearer ${token}`,
