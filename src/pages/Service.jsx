...
export const Service = () => {
    return (
        <div style={{ textAlign: 'center', backgroundColor: 'grey', padding: '20px' }}>
            <h1>Our Services</h1>
            <br></br>
            <br></br>
            <br></br>
            ...
            <div>
                <h1><strong>HEALTH CARE INSURANCE</strong></h1>
                <h1><strong>MOTOR INSURANCE</strong></h1>
                <h1><strong>MARINE INSURANCE</strong></h1>
